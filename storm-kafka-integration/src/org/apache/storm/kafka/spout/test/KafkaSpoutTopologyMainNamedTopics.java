...
public class KafkaSpoutTopologyMainNamedTopics {
    ...
    protected void submitTopologyLocalCluster(StormTopology topology, Config config) throws InterruptedException {
    	System.out.println("submitTopologyLocalCluster");
    ...
    protected void submitTopologyRemoteCluster(String arg, StormTopology topology, Config config) throws Exception {
    	System.out.println("submitTopologyRemoteCluster");
    ...
    protected StormTopology getTopolgyKafkaSpout() {
    	System.out.println("getTopolgyKafkaSpout");
    ...
    protected Map<String,Object> getKafkaConsumerProps() {
    	System.out.println("getKafkaConsumerProps");
        Map<String, Object> props = new HashMap<>();
//        props.put(KafkaSpoutConfig.Consumer.ENABLE_AUTO_COMMIT, "true");
        //props.put(KafkaSpoutConfig.Consumer.BOOTSTRAP_SERVERS, "127.0.0.1:9092");
        props.put(Config.NIMBUS_HOST, "210.96.177.68");
        props.put(Config.NIMBUS_THRIFT_PORT, "6627");
        props.put("zookeeper.connect", "210.96.177.67:2181");
        props.put(KafkaSpoutConfig.Consumer.BOOTSTRAP_SERVERS, "210.96.177.67:9092");
        props.put(KafkaSpoutConfig.Consumer.GROUP_ID, "console-consumer-72525");
